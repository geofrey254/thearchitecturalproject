                    ...
                    <div className="bg-white">
                      {[
                        ...
                        <a
                          key={i}
                          href={service.href}
                          className="flex items-start p-4 hover:bg-amber-50 transition-colors group border-l-2 border-transparent hover:border-amber-400"
                        >
                    ...
                    <div className="py-2">
                      {[
                        ...
                        <a
                          key={i}
                          href="#"
                          className="flex items-center px-6 py-3 text-slate-700 hover:bg-amber-50 hover:text-amber-700 transition-colors border-l-2 border-transparent hover:border-amber-400"
                        >
            ...
            <div className="flex items-center space-x-3 p-3 bg-slate-100 rounded-lg hover:bg-amber-50 transition-colors group">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-slate-900 hover:text-amber-600 transition-colors font-semibold text-sm"
                >
                  +1 (555) 123-4567
                </a>
              </div>
      ...
      {isOpen && (
        <div className="lg:hidden bg-white border-t border-slate-200">
          <div className="px-6 py-6 space-y-6">
            <Link
              href="/"
              className="block text-slate-700 hover:text-amber-600 font-medium py-2 transition-colors"
            >
              Home
            </Link>
            ...
            <div className="pt-6 border-t border-slate-200 space-y-4">
              <div className="flex items-center space-x-3 p-4 bg-slate-100 rounded-lg">
                ...
                <div>
                  ...
                  <a
                    href="tel:+15551234567"
                    className="text-slate-900 hover:text-amber-600 transition-colors font-semibold"
                  >
                    +1 (555) 123-4567
                  </a>
                </div>
